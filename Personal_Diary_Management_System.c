...
int main()
{
    int ch;
     gotoxy(20,1);
     system("cls");
    char d[100]=" PASSWORD PROTECTED PERSONAL DIARY";
    int i=0,j;
    gotoxy(10,4);
    for(j=0;j<30;j++)
    {
...
void addrecord( )
{
    ...
    int ch;
     gotoxy(20,1);
     system("cls");
    char d[100]=" WELCOME TO THE ADD MENU";
    int i=0,j;
    gotoxy(10,4);
    for(j=0;j<30;j++)
    {
...
void editrecord()
{
    ...
    do
    {
        printf("\n\tENTER THE DATE OF RECORD TO BE EDITED:");
        fflush(stdin);
        gets(filename);
        printf("\n\tENTER TIME:[hh:mm]:");
        gets(time);
